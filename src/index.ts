// @ts-nocheck
import { processImages } from './generate/images';
import { processMarkdown, processRoutes, buildMenuTree } from './generate/index.js'
import { buildMenuTree } from './generate/index.js'
